/**
 * Esto va a mandar una petición HTTP al agente de bloqueo que corre en el PC remoto
 * (esto es lo que va a hacer con la ip de mi computadora http://192.168.1.79:5050/bloquear).
 *
